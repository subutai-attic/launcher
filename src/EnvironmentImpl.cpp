...
const std::string SubutaiLauncher::EnvironmentImpl::EXTRA_PATH="/usr/local/bin:";

SubutaiLauncher::EnvironmentImpl::EnvironmentImpl() 
{
...
unsigned SubutaiLauncher::EnvironmentImpl::processorNum() 
{
    _logger->trace("Environment: Get CPU number");
    return Poco::Environment::processorCount();
}

unsigned SubutaiLauncher::EnvironmentImpl::is64() 
{
...
ULORAMSIZE_T SubutaiLauncher::EnvironmentImpl::ramSize() 
{
...
unsigned SubutaiLauncher::EnvironmentImpl::versionVBox() 
{
...
bool SubutaiLauncher::EnvironmentImpl::vtxEnabled() 
{
#if LAUNCHER_LINUX
    ...
    if (rc != 0)
    {
        _logger->error("Failed to run sysctl. VTX query failed");
        return false;
    }
    std::string pBuffer;
    Poco::PipeInputStream istr(pOut);
...
std::string SubutaiLauncher::EnvironmentImpl::versionOS() 
{
...
std::string SubutaiLauncher::EnvironmentImpl::versionNumber()
{
#if LAUNCHER_MACOS
    Poco::Process::Args pArgs;
...
std::string SubutaiLauncher::EnvironmentImpl::cpuArch() 
{
#ifndef LAUNCHER_WINDOWS
...
unsigned int SubutaiLauncher::EnvironmentImpl::cpuNum() 
{
    return Poco::Environment::processorCount();
}

std::string SubutaiLauncher::EnvironmentImpl::getVar(const std::string& name, const std::string& defaultValue) 
{
    return Poco::Environment::get(name, defaultValue);
}

std::string SubutaiLauncher::EnvironmentImpl::setVar(const std::string& name, const std::string& value)
{
    Poco::Environment::set(name, value);
    return value;
}

std::string SubutaiLauncher::EnvironmentImpl::getDefaultGateway()
{
...
bool SubutaiLauncher::EnvironmentImpl::isNSSMInstalled()
{
...
bool SubutaiLauncher::EnvironmentImpl::registerService(const std::string& name, const std::string& path, std::vector<std::string> args)
{
...
bool SubutaiLauncher::EnvironmentImpl::unregisterService(const std::string & name)
{
...
bool SubutaiLauncher::EnvironmentImpl::startService(const std::string& name)
{
...
bool SubutaiLauncher::EnvironmentImpl::stopService(const std::string& name)
{
...
void SubutaiLauncher::EnvironmentImpl::CreateShortcut(const std::string& source, const std::string& name)
{
#if LAUNCHER_WINDOWS
...
int32_t SubutaiLauncher::EnvironmentImpl::updatePath(const std::string& path)
{
#if LAUNCHER_WINDOWS
...
bool SubutaiLauncher::EnvironmentImpl::killProcess(const std::string & name)
{
#if LAUNCHER_WINDOWS
...
std::string SubutaiLauncher::EnvironmentImpl::getDesktopDirectory()
{
#if LAUNCHER_WINDOWS
...
bool SubutaiLauncher::EnvironmentImpl::isVBoxInstalled()
{
#if LAUNCHER_WINDOWS
	enum { BUFF_SIZE = 1024 * 4 };
	LPBYTE buffer = (LPBYTE)malloc(BUFF_SIZE);
...
bool SubutaiLauncher::EnvironmentImpl::writeE2ERegistry(const std::string & name)
{
#if LAUNCHER_WINDOWS
...
BOOL SubutaiLauncher::EnvironmentImpl::terminateWinProcess(DWORD dwProcessId, UINT uExitCode)
{
#if LAUNCHER_WINDOWS
